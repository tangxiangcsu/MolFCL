...
from .scaffold import log_scaffold_stats, scaffold_split, cluster_split, scaffold_split_no_balance,random_scaffold_split
...
# =============================================================================
    ...
    elif split_type == 'scaffold_split':
        return scaffold_split_no_balance(data,sort=False,logger=logger)
    
    elif split_type == 'random_scaffold_split':
        return random_scaffold_split(data, sizes=sizes, sort=True, logger=logger)
