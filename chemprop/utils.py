...
from chemprop.models import build_model, MoleculeModel, build_pretrain_model, add_BRICS_prompt
...
def build_lr_scheduler(optimizer: Optimizer, args: Namespace, total_epochs: List[int] = None) -> _LRScheduler:
    ...
    init_lr=[args.init_lr, args.init_lr*args.increase_parm],
    max_lr=[args.max_lr, args.max_lr*args.increase_parm],
    final_lr=[args.final_lr, args.final_lr*args.increase_parm]
    )
...
class Early_stop(object):
    def __init__(self,patience=15,minimize_score=False) -> None:
